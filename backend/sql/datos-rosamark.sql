...
VALUES
  ...
  (7, 2, 1, NULL, 'Queso Americano', 85, 'https://www.grillhouse.mx/cdn/shop/products/8147VLLTamericano175gSIM21.png?v=1753148155', 'Queso Americano de excelente calidad y gran sabor.', TRUE, 30, 1),
  ...
  (12, 4, 1, NULL, 'Nuggets de Pollo', 75, 'https://i5-mx.walmartimages.com/mg/gm/3pp/asr/06002a44-7bfa-4520-9e26-c3ea6d75de32.2cd88ba9d49c834deef08f47d8f0c7e8.jpeg?odnHeight=612&odnWidth=612&odnBg=FFFFFF, 'Nuggets de pollo frescos y listos para preparar.', FALSE, 30, 1),
  ...
  (22, 1, 1, NULL, 'Uva', 55, 'https://tecolotito.elsiglodedurango.com.mx/cdn-cgi/image/format=auto,width=1024/i/2018/05/694949.jpeg', 'Uvas frescas y jugosas, ideales para picar o preparar postres.', FALSE, 30, 1),
  ...
  (31, 1, 1, NULL, 'Uva Verde', 52, 'https://snapcalorie-webflow-website.s3.us-east-2.amazonaws.com/media/food_pics_v2/medium/seedless_green_grapes.jpg', 'Uva verde sin semilla, crujiente y refrescante.', FALSE, 30, 1),
  (32, 1, 1, NULL, 'Sandía', 18, 'https://soycomocomo.es/media/2016/06/sandia-2.gif', 'Sandía jugosa, perfecta para los días de calor.', FALSE, 30, 1),
  ...
  (34, 1, 1, NULL, 'Aguacate Hass', 78, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRGFksBbSslYei2H8F89H0a9YH-DXjYkwdchWgL7602DA&s=10', 'Aguacate hass cremoso, listo para el guacamole.', TRUE, 25, 1),
  (35, 1, 1, NULL, 'Zanahoria', 16, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRSfzMuNKgOUrl6PGQ340cmtHmSO-92lm8xtkDaYlwrb7DDBKI1qcGTccgx&s=10', 'Zanahoria fresca, ideal para sopas y ensaladas.', FALSE, 30, 1),
  (36, 1, 1, NULL, 'Brócoli', 32, 'https://static.nationalgeographicla.com/files/styles/image_3200/public/brocoli-2.jpg?w=1600&h=1063', 'Brócoli verde y firme, cosechado esta semana.', FALSE, 30, 1),
  (37, 2, 1, 4, 'Queso Manchego', 110, 'https://supermode.com.mx/cdn/shop/products/4716_2708d1ad-9634-4e96-a520-e7e2381fd52f.jpg?v=1698796056', 'Queso manchego semicurado, ideal para gratinar.', TRUE, 20, 1),
  ...
  (41, 2, 1, NULL, 'Queso Panela', 82, 'https://www.lyncott.mx/wp-content/uploads/2021/11/Panela.jpg', 'Queso panela fresco, bajo en grasa.', FALSE, 30, 1),
  ...
  (50, 4, 1, NULL, 'Pechuga de Pollo', 88, 'https://kosherhouse.mx/cdn/shop/files/pechugadepollosinhueso.jpg?v=1691773142', 'Pechuga de pollo sin hueso ni piel.', TRUE, 35, 1),
  (51, 4, 1, NULL, 'Chuleta de Cerdo', 105, 'https://i5-mx.walmartimages.com/samsmx/images/product-images/img_large/000036423-2l.jpg?odnHeight=612&odnWidth=612&odnBg=FFFFFF', 'Chuleta de cerdo con hueso, corte grueso.', FALSE, 30, 1),
  (52, 4, 1, 7, 'Salmón Fresco', 340, 'https://ingredienta.com/wp-content/uploads/2024/11/SALMONCANALOMO-800x800.png', 'Filete de salmón fresco del Atlántico.', TRUE, 15, 1),
  ...
  (55, 4, 1, NULL, 'Chorizo', 68, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRvkan_cSEm33WmYd8afcuZeBfNr1Tek9lG-skPPAED03_fWydrMedb-Oc&s=10', 'Chorizo artesanal, ideal para el desayuno.', FALSE, 30, 1),
